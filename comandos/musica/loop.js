...
module.exports = {
  ...
  if(!message.member.voice.channel) return message.channel.send({embed: {
      ...
      .setDescription(`<a:disco:913640838884655134> **Repeticion automatica** ${queue.repeatMode ? queue.repeatMode === 2 ? '**activada en toda la PlayList 📜**' : '**activada en solo esta Canción** 🎵' : '**Apagada** ❌'}`,)
      .setColor("835aa2")
